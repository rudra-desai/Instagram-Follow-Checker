...
const instagram = {
    ...
    fetchFollowing_and_compare: async() => {
        ...
        var following = await instagram.page.$eval("a[href='/" + user_name + "/following/'] > span", el => el.innerText);
        following = parseInt(following);
        
        var lis = await instagram.page.$eval("div[role='dialog'] > div:nth-child(3) > ul > div", el => el.getElementsByTagName("li").length);
        following = parseInt(following);
    ...
    fetchFollowers: async() => {
        ...
        var followers = await instagram.page.$eval("a[href='/" + user_name + "/followers/'] > span", el => el.innerText);
